...
class FlashScopeTestCase(TestCase):
    ...
    def test_get_item(self):
        ...
        """
        get_item = lambda: self.flash['message']
    ...
    def test_get(self):
        ...
        """
        self.assertEqual('Something', self.flash.get('message', 'Something'))
        self.flash['message'] = 'Message'
    ...
    def test_pop(self):
        ...
        """
        self.assertEqual(None,self.flash.pop('message'))
        self.flash['message'] = 'Message'
    ...
    def test_has_key(self):
        ...
        """
        self.assertFalse(self.flash.has_key('message'))
        self.flash['message'] = 'Message'
    ...
    def test_alternative_now(self):
        ...
        """
        self.flash.now(message='Message')
        self.assertEqual('Message', self.flash['message'])
        self.flash.update()
        self.assertFalse('message' in self.flash)
    ...
    def test_now_get_item(self):
        ...
        """
        self.flash.now['message'] = 'Message'
        self.assertEqual('Message', self.flash.now['message'])

    def test_now_contains(self):
        """"key in flash.now" syntax should be supported.
        """
        self.assertFalse('message' in self.flash.now)
        self.flash.now['message'] = 'Message'
        self.assertTrue('message' in self.flash.now)
